...
//Scores preload, close preset, middle preset and far preset
    ...
    private final Pose lineup1Pose = new Pose(144-89, 41, Math.toRadians(180)); // Farthest (First Set)
    private final Pose gobble1Pose = new Pose(144-125, 35, Math.toRadians(180)); // Farthest (First Set)
    private final Pose lineup2Pose = new Pose(144-89, 65, Math.toRadians(180)); // Middle (Second Set)
    private final Pose gobble2Pose = new Pose(144-127.5, 59, Math.toRadians(180)); // Middle (Second Set)
    ...
    private final Pose scorePose3 = new Pose(144-88, 19, Math.toRadians(111.5));
