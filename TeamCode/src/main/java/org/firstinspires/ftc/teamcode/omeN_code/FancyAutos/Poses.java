...
public class Poses {
    ...
    public static final Pose lineupFarPoseR = new Pose(89, 44, Math.toRadians(0)); // Farthest (First Set)
    public static final Pose gobbleFarPoseR = new Pose(125, 34, Math.toRadians(0)); // Farthest (First Set)
