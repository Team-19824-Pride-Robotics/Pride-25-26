...
public class redAuto extends OpMode {
    ...
    private final Pose scorePose = new Pose(89, 100, Math.toRadians(42)); // Scoring Pose of our robot. It is facing the goal at a 136 degree angle.
    private final Pose lineup1Pose = new Pose(89, 87, Math.toRadians(0)); // Highest (First Set)
    private final Pose gobble1Pose = new Pose(126, 87, Math.toRadians(0)); // Highest (First Set)
    ...
    private final Pose scorePose2 = new Pose(89, 100, Math.toRadians(42));
    private final Pose scorePose3 = new Pose(89, 100, Math.toRadians(42));
